...
if [[ "${systemLanguage}" == "zh_CN" ]]; then 
    ...
    langChooseResOp3="(3) 2560x1600 显示屏"
...
create_res_1 1680x1050 1600x1000 1440x900 1280x800
...
create_res_4 1920x1200 1680x1050 1600x1000 1512x945 1440x900 1280x800 1024x640 960x540
